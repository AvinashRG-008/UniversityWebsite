<! --@ author Avinash R G -->
<! --It is for admin to add different ideas-->
...
<body  background="images/s3.jpg">
<center><h1><font size="15" color="white">UNIVERSITY WEBSITE</font></h1></center><br>
<form:form action="saveAdminIdea" method="post" modelAttribute="ideas">
	<h1>
		<font size="10" color="white">
			<center>Admin Add Idea</center>
	</font>
	</h1>
<table cellspacing="4">
                  <tr>
                  <td> <h1 > <font  color="white"> &nbsp &nbsp Idea Name &nbsp &nbsp</h1></td>
                  <td> <form:input path="ideaName" id="ideaname" class="form-control"/><font color="red"> <form:errors path="ideaName"></form:errors></font></td>              		
                  </tr>
             </table>
