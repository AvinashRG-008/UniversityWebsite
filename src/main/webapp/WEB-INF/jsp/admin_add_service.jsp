...
<! --It is for admin to add different services with seats available and volunteers required-->
...
<form:form action="saveAdminService" method="post" modelAttribute="services">
