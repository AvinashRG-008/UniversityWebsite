...
<! --It is for admin to delete different events-->
...
<form:form action="deleteAdminEvent" method="post" modelAttribute="events">
	<h1>
		<font size="10" color="white">
			<center>Delete Events</center>
	</font>
	</h1>
<table cellspacing="4">
                  <tr>
                  <td> <h2 id="ex1"> <font  color="white">Event Name</font></h1>
                  </td>
                  <td> <form:input path="eventName" id="ex2" class="form-control"/></td>
                  </table>  
                  </br>
